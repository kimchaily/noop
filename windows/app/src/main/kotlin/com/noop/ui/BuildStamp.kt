...
/**
 * The tiny build stamp under the CHOOP wordmark at the top of Today.
 *
 ...
 *    answer "which build am I looking at?" in a bug report. The branch/sha come from CI; local
 *    builds leave them blank and the segment is omitted rather than showing an empty "@".
 *
 * Pure and unit-tested; the composable caller just renders the string.
 */
fun buildStamp(
    channel: String,
    versionName: String,
