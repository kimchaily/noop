 ...
 * app) and you get off-device backup with NO in-app cloud account, no OAuth, no secrets - Choop only
...
object BackupSyncPrefs {
    ...
    /** Master enable for the daily auto-backup. Default OFF (every Choop automation is opt-in). */
