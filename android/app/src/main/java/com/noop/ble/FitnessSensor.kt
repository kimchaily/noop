 ...
 * We decode the fields Choop surfaces in a live workout (speed, cadence, power, and the cumulative
 ...
 * Choop's own clean re-implementation of the public spec (no GPL/AGPL source consulted — facts only).
 */
